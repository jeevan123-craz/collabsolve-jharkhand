    ...
    <div className="pt-8 px-gutter max-w-container-max mx-auto pb-xl">
      <motion.div initial="hidden" animate="visible" variants={containerVariants}>
        ...
        <motion.div variants={itemVariants} className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2 p-1 bg-surface-container rounded-xl border border-surface-variant">
            <button
        ...
        {useAISearch ? (
          <motion.div
            ...
            className="mb-12 bg-surface-container-low p-6 rounded-2xl border border-surface-variant shadow-sm"
          >
            <GlobalAISearch />
          </motion.div>
        ) : (
